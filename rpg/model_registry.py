...
DEFAULT_MODEL_CATALOG: dict[str, Any] = {
    ...
    "apis": [
            ...
            "models": [
                {
                    ...
                    "enabled": True,
                    "capabilities": ["text", "streaming", "image_input", "file_input"],
                },
                {
                    "id": "gemini-2.5-flash",
        ...
        },
        {
            ...
            "models": [
                {"id": "claude-opus-4-5",   "real_name": "claude-opus-4-5",   "display_name": "Claude Opus 4.5",   "enabled": True, "capabilities": ["text", "streaming", "image_input", "file_input"]},
                {"id": "claude-sonnet-4-6", "real_name": "claude-sonnet-4-6", "display_name": "Claude Sonnet 4.6", "enabled": True, "capabilities": ["text", "streaming", "image_input", "file_input"]},
                {"id": "claude-haiku-4-5",  "real_name": "claude-haiku-4-5",  "display_name": "Claude Haiku 4.5",  "enabled": True, "capabilities": ["text", "streaming"]},
            ],
        },
        {
            "id": "openai",
            ...
            "models": [
                {"id": "gpt-4o",       "real_name": "gpt-4o",       "display_name": "GPT-4o",       "enabled": True, "capabilities": ["text", "streaming", "image_input"]},
                {"id": "gpt-4o-mini",  "real_name": "gpt-4o-mini",  "display_name": "GPT-4o mini",  "enabled": True, "capabilities": ["text", "streaming"]},
                {"id": "gpt-4-turbo",  "real_name": "gpt-4-turbo",  "display_name": "GPT-4 Turbo",  "enabled": True, "capabilities": ["text", "streaming"]},
            ],
        },
        {
            "id": "openrouter",
            ...
            "models": [
                {"id": "anthropic/claude-sonnet-4.5",     "real_name": "anthropic/claude-sonnet-4.5",     "display_name": "Claude Sonnet 4.5 (OR)", "enabled": True, "capabilities": ["text", "streaming"]},
                {"id": "openai/gpt-4o",                   "real_name": "openai/gpt-4o",                   "display_name": "GPT-4o (OR)",           "enabled": True, "capabilities": ["text", "streaming"]},
                {"id": "google/gemini-2.5-pro",           "real_name": "google/gemini-2.5-pro",           "display_name": "Gemini 2.5 Pro (OR)",   "enabled": True, "capabilities": ["text", "streaming"]},
            ],
        },
        {
            "id": "siliconflow",
            ...
            "models": [
                {"id": "deepseek-ai/DeepSeek-V3",    "real_name": "deepseek-ai/DeepSeek-V3",    "display_name": "DeepSeek V3",    "enabled": True, "capabilities": ["text", "streaming"]},
                {"id": "Qwen/Qwen2.5-72B-Instruct",  "real_name": "Qwen/Qwen2.5-72B-Instruct",  "display_name": "Qwen 2.5 72B",   "enabled": True, "capabilities": ["text", "streaming"]},
            ],
        },
        {
            "id": "minimax",
        ...
        },
        {
            ...
            "models": [
                {"id": "qwen-max",         "real_name": "qwen-max",         "display_name": "通义千问 Max",        "enabled": True, "capabilities": ["text", "streaming"]},
