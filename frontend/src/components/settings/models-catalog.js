  ...
  },
  {
    ...
    models: ((() => {
      const data = [
        ...
        ["x-ai/grok-4.6", "Grok 4.6", ["text", "vision", "tool-use", "reasoning"], "$2.10 / $6.30", "500K", true],
        ["x-ai/grok-4.5", "Grok 4.5", ["text", "vision", "reasoning"], "$2.10 / $6.30", "500K", false],
        ["x-ai/grok-4.3", "Grok 4.3", ["text", "vision", "reasoning"], "$1.31 / $2.63", "1M", false],
